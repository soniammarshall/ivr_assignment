...
def pixel2meter(yellow_mask, blue_mask):
    circle1Pos = detect_color(yellow_mask)
    circle2Pos = detect_color(blue_mask)
...
def detect_joint_angles(self, yellow_mask, blue_mask, green_mask, red_mask, to_meters_ratio):
    center = to_meters_ratio * self.detect_color(yellow_mask)
    circle1Pos = to_meters_ratio * self.detect_color(blue_mask)
    circle2Pos = to_meters_ratio * self.detect_color(green_mask)
    circle3Pos = to_meters_ratio * self.detect_color(red_mask)
